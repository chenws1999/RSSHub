...
mongoose.connect('mongodb://localhost:27000/balala?authSource=admin&w=1', {user: settings.mongouser, pass: settings.mongopass, useNewUrlParser: true })
...
async function main5 () {
	...
	await origin1.save()
	// const origin1 = await FeedOrigin.findOne({code: 'bilibili'})
